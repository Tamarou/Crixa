...
https://metacpan.org/release/Crixa

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends Crixa
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends Crixa
...
The code for this distribution is [hosted at GitHub](https://github.com/Tamarou/Crixa).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=Crixa)
or [via email](bug-crixa@rt.cpan.org.
